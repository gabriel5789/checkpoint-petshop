...
public class ClienteController {
	...
	public String atualizarPF(@Valid ClientePF clientePF, BindingResult result, RedirectAttributes redirectAttributes) {
		if(result.hasErrors())
			return "cliente/editar-pf";
	...
	public String atualizarPJ(@Valid ClientePJ clientePJ, BindingResult result, RedirectAttributes redirectAttributes) {
		if(result.hasErrors())
			return "cliente/editar-pj";
